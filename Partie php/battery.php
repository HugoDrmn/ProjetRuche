...
//------------si des données  sont recues on les enregistrent dans le fichier battery.ini ---------
if( !empty($_POST['envoyer'])){
    ...
    $rendement = filter_input(INPUT_POST, 'rendement', FILTER_VALIDATE_FLOAT);
    if($capacite != NULL && $charge!= NULL && $rendement!= NULL) {
...
<html lang="fr">
    <head>
        ...
        <script type="text/javascript">
            ...
            function affiche(data) {               // fonction pour afficher les données recues
                    ...
                    <div class="popin">
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo $_SERVER['SCRIPT_NAME'] ?>" name="configuration" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.001" name="capacite" class="form-control" <?php echo 'value="' . $_POST['capacite'] . '"'; ?> />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.0001"  name="charge" class="form-control" <?php echo 'value="' . $_POST['charge'] . '"'; ?> />
                            </div>
