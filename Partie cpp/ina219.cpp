/*!
    ...
    \detail   Pour comprendre la calibration du INA219
    	...
    	L'ADC peut mesurer des tensions comprises entre Â± 40mV (Â± pour la mesure du courant bidirectionnel).
    	le PGA est un diviseur de tension programmable par 1, 2, 4, or 8
    	Cela donne Ã  l'INA219 une plage effective de Â± 40 mV, Â± 80 mV, Â± 160mV, ou Â± 320mV respectivement.
...
float ina219::obtenirTension_V(){
    ...
    //printf("%d\n",data >> 3); // Ã  décommenter pour  évaluer le quantum expérimentalement
...
float ina219::obtenirCourantMoyen_A(int nb){
    ...
    // Tri des valeurs grÃ¢ce Ã  la fonction std::sort
    sort (valeur.begin(), valeur.end());
    // Somme des valeurs sans les deux extrêmes
...
/*!
    ...
    et minimal lorsquâ€™elle est vide.
    12.86 -> 100%
    12.22 -> 50%
